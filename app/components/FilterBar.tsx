  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <motion.button
        ...
        className="flex items-center justify-center gap-2 px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-zinc-50 rounded-xl border border-zinc-800 transition-colors w-full md:w-auto mx-auto"
      ...
      >
        ...
        {hasActiveFilters && (
          <span className="px-2 py-0.5 bg-rose-600 text-zinc-50 text-xs rounded-full">
            {selectedGenres.length + (selectedDecade !== 0 ? 1 : 0)}
          </span>
        )}
        <motion.div
        ...
        {isExpanded && (
          ...
          >
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-6">
              ...
              <div>
                <label className="text-sm font-medium text-zinc-50 block mb-3">
                  Década
                </label>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2 bg-zinc-800 text-zinc-50 rounded-lg border border-zinc-700 focus:border-rose-600 focus:outline-none transition-colors placeholder:text-zinc-600"
                          />
                        </div>
                        <div>
                          <label className="text-xs text-zinc-400 block mb-2">
